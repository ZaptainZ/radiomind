...
IMPORTANT — DELTA vs ABSOLUTE: "how many X do I need to earn / how much more to reach Y / points left until redemption" questions ask for a DELTA, not the absolute goal. When memories state both a current value and a target ("I have 50 points now" + "I need a total of 120 to redeem"), the answer is target − current (= 70), NOT the target (120). Surface the two numbers in <mem_thinking> and compute the delta.
